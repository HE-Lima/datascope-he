...
async def transition_to_gui(page: ft.Page):
    ...
    dialog_controls.update({
        "btn_log": ft.ElevatedButton(
            text="Test Logging & Error Handler",
    ...
    button_row = ft.Row(
        controls=[btn_load, dialog_controls["btn_log"], dialog_controls["btn_data"], dialog_controls["btn_visual"]],
        alignment=ft.MainAxisAlignment.CENTER,
        spacing=10,
    )
